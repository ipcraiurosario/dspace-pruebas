...
import org.dspace.bibliography.CitationExport;
 ...
 * It supports CITA format but can be expanded to other formats.
 * 
 * @author Andres Quast (Original Servlet version)
 * @author Adan Roman Ruiz
 * @author Marta Rodriguez Gonzalez
 * @author Sergio LÃ³pez GonzÃ¡lez
 */

// BibliographyReader.java
public class BibliographyCitationReader extends AbstractReader implements Recyclable {
	...
	try {
	    ...
	    result = CitationExport.renderCitaFormat(handle, context);
	    filename = handle.replaceAll("/", "-") + "-apa.txt";
