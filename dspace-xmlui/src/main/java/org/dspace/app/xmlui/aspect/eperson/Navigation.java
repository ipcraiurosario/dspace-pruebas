...
import org.dspace.app.xmlui.aspect.eperson.sipimport.ControlledVocabularyGestionUtils;
...
public class Navigation extends AbstractDSpaceTransformer implements CacheableProcessingComponent
{
    ...
    private static final Message T_administrative_import_controlled_vocabulary =message("xmlui.administrative.Navigation.administrative_import_controlled_vocabulary");
    private static final Message T_administrative_export_controlled_vocabulary =message("xmlui.administrative.Navigation.administrative_export_controlled_vocabulary");
            ...
            UIException, SQLException, IOException, AuthorizeException
    {
        ...
        if(ControlledVocabularyGestionUtils.isControlledVocabularyImportAllowed(this.context)){
            List context=options.addList("context");
            context.setHead(T_context_head);
            context.addItemXref(contextPath+"/controlledvocabularyimport", T_administrative_import_controlled_vocabulary);
            context.addItemXref(contextPath+"/controlledvocabularyexport", T_administrative_export_controlled_vocabulary);
        }
