...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:dri="http://di.tamu.edu/DRI/1.0/" xmlns:mets="http://www.loc.gov/METS/"
    ...
    <xsl:template match="dim:dim" mode="itemSummaryView-DIM">
        <div class="item-summary-view-metadata">
		    ...
		    <xsl:call-template name="itemSummaryView-DIM-additional-authors" />
                    <xsl:call-template name="itemSummaryView-DIM-director" />
	            <xsl:call-template name="itemSummaryView-DIM-codirector" />
		    <xsl:call-template name="itemSummaryView-DIM-presenter" />
		    <xsl:call-template name="itemSummaryView-DIM-tutor" />
     	            <xsl:call-template name="itemSummaryView-DIM-contributor" />
                    ...
                    <xsl:call-template name="citation_icons" />
                </div>
                <div class="col-sm-9">
                    ...
                    <xsl:call-template name="itemSummaryView-DIM-subjectlemb" />
    ...
    <xsl:template name="itemSummaryView-DIM-subjectlemb">
        <xsl:if test="dim:field[@element='subject' and @qualifier='lemb']">
            <div class="simple-item-view-subjectlemb item-page-field-wrapper table jelspa">
                ...
                <div>
                    <xsl:for-each select="dim:field[@element='subject' and @qualifier='lemb']">
                        <xsl:choose>
                            <xsl:when test="node()">
                                <a>
                                    <xsl:attribute name="href">
    ...
    <xsl:template name="itemSummaryView-DIM-additional-authors">
        <xsl:if test="dim:field[@element='contributor'][@qualifier='author' and descendant::text()] ">
            <div class="simple-item-view-authors item-page-field-wrapper table">
                <h5>
                    <i18n:text>xmlui.dri2xhtml.METS-1.0.item-additional-authors</i18n:text>
                </h5>
                <xsl:choose>
                    <xsl:when test="dim:field[@element='contributor'][@qualifier='author']">
                        <xsl:for-each select="dim:field[@element='contributor'][@qualifier='author']">
   ...
   <!---->
   <xsl:template name="itemSummaryView-DIM-codirector">
        <xsl:if test="dim:field[@element='contributor'][@qualifier='coadvisor' and descendant::text()] ">
            <div class="simple-item-view-authors item-page-field-wrapper table">
                <h5>
                    <i18n:text>xmlui.dri2xhtml.METS-1.0.item-codirector</i18n:text>
                </h5>
                <xsl:choose>
                    <xsl:when test="dim:field[@element='contributor'][@qualifier='coadvisor']">
                        <xsl:for-each select="dim:field[@element='contributor'][@qualifier='coadvisor']">
                            <xsl:call-template name="itemSummaryView-DIM-authors-entry" />
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
    ...
    <xsl:template name="itemSummaryView-DIM-tutor">
        <xsl:if test="dim:field[@element='contributor'][@qualifier='tutor' and descendant::text()] ">
            <div class="simple-item-view-authors item-page-field-wrapper table">
                <h5>
                    <i18n:text>xmlui.dri2xhtml.METS-1.0.item-tutor</i18n:text>
                </h5>
                <xsl:choose>
                    <xsl:when test="dim:field[@element='contributor'][@qualifier='tutor']">
                        <xsl:for-each select="dim:field[@element='contributor'][@qualifier='tutor']">
                            <xsl:call-template name="itemSummaryView-DIM-authors-entry" />
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
    ...
    <xsl:template name="itemSummaryView-DIM-presenter">
        <xsl:if test="dim:field[@element='contributor'][@qualifier='presenter' and descendant::text()] ">
            <div class="simple-item-view-authors item-page-field-wrapper table">
                <h5>
                    <i18n:text>xmlui.dri2xhtml.METS-1.0.item-presenter</i18n:text>
                </h5>
                <xsl:choose>
                    <xsl:when test="dim:field[@element='contributor'][@qualifier='presenter']">
                        <xsl:for-each select="dim:field[@element='contributor'][@qualifier='presenter']">
                            <xsl:call-template name="itemSummaryView-DIM-authors-entry" />
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
    ...
    <xsl:template name="itemSummaryView-DIM-contributor">
        <xsl:if test="dim:field[@element='contributor'][@qualifier='' and descendant::text()] ">
            <div class="simple-item-view-authors item-page-field-wrapper table">
                <h5>
                    <i18n:text>xmlui.dri2xhtml.METS-1.0.item-contributor</i18n:text>
                </h5>
                <xsl:choose>
                    <xsl:when test="dim:field[@element='contributor'][@qualifier='']">
        ...
        <span>
            ...
            <a>
				...
				<!-- AM01 - Extraccion de informacion VIVO-->
                                <xsl:attribute name="class">
                                        <xsl:text>repository-person-info</xsl:text>
                                </xsl:attribute>
                                <xsl:attribute name="repository-person-info">
...
<xsl:template name="citation_icons">
	<h5 id="visible-xs" class="item-title">
		<i18n:text>xmlui.dri2xhtml.METS-1.0.item-citation-icons</i18n:text>
	</h5>
	<div class="citation-link">
		<a>
			<xsl:attribute name="href"><xsl:text>https://scholar.google.com/scholar?as_occt=title&amp;as_q=</xsl:text>&quot;<xsl:value-of select="dim:field[@element='title'][not(@qualifier)][1]/node()" />&quot;</xsl:attribute>

				 <xsl:attribute name="target"><xsl:text>_blank</xsl:text></xsl:attribute>
			<img>
				<xsl:attribute name="src">
					<xsl:text>/themes/Mirage2/images/ur/google_schoolar.png</xsl:text>
				</xsl:attribute>
				<xsl:attribute name="class">
                                        <xsl:text>citation-link</xsl:text>
                                </xsl:attribute>
		...
		<div class="citation-link">
			<a>
				<xsl:attribute name="href">
						<xsl:text>https://academic.microsoft.com/#/search?q=</xsl:text>
						<xsl:value-of select="dim:field[@element='title'][not(@qualifier)][1]/node()" />

						<xsl:text>&amp;iq=@</xsl:text>
						<xsl:value-of select="dim:field[@element='title'][not(@qualifier)][1]/node()" />
						<xsl:text>@&amp;filters=&amp;from=0&amp;sort=0</xsl:text>
				</xsl:attribute>

						 <xsl:attribute name="target"><xsl:text>_blank</xsl:text></xsl:attribute>
				<img>
						<xsl:attribute name="src">
								<xsl:text>/themes/Mirage2/images/ur/academic_search_icon.png</xsl:text>
						</xsl:attribute>
						<xsl:attribute name="class">
								<xsl:text>citation-link</xsl:text>
						</xsl:attribute>
