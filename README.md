=======
# dspace-crai
DSpace 6.0 - Piwik OpenAIRE - CRAI 

## EJECUTAR COMO dspace !!! #
```bash 
...
#Antes de levantar el container [p.e. Tomcat], eliminar el flag de reindexación automática de discovery, si existe
rm [dspace]/solr/search/conf/reindex.flag

#Primero, ejecutar manualmente la reindexación del core 'authority'
bash [dspace]/bin/dspace index-authority

#Una vez finalizado el comando anterior, [re]indexar discovery
bash [dspace]/bin/dspace index-discovery -bos
```
