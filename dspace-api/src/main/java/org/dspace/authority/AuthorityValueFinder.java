...
public class AuthorityValueFinder {
    ...
    public List<AuthorityValue> findByExactValue(Context context, String schema, String element, String qualifier, String value) {
        String field = fieldParameter(schema, element, qualifier);
        return findByExactValue(context, field, value);
    }
