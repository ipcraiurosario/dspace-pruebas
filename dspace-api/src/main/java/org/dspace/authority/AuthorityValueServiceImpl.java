...
//            }
//        }
		Map<String, AuthorityValue> types = AuthorityValue.getAuthorityTypes().getFieldDefaults();
		String mdf = metadataString;
		if (mdf.contains("[")) {
			mdf = StringUtils.substringBefore(mdf, "[");
		}
		if (types.get(mdf.replaceAll("[.]", "_")) != null) {
			fromAuthority = types.get(mdf.replaceAll("[.]", "_"));
		}
