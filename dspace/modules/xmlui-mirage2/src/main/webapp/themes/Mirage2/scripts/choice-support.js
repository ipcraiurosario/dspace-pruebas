...
function DSpaceChoiceLookup(url, field, formID, valueInput, authInput,
                            confIndicatorID, collectionID, isName, isRepeating, choicesLimit, isReadOnly) {
    ...
    url += '?field=' + field + '&formID=' + formID + '&valueInput=' + valueInput +
            ...
            '&limit=' + choicesLimit + //choices limit is configurable now...
...
function DSpaceChoicesLoad(form) {
    ...
    var isReadOnly = $('*[name = paramIsReadOnly]').val() == 'true';
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            //Set as "read-only" the field that hold selected values, if configured this way...
            if(isReadOnly){
            	if (isName) {
                    $('*[name = text1]').prop("readonly", true);
                    $('*[name = text2]').prop("readonly", true);
                }
                else
                    $('*[name = text1]').prop("readonly", true);
            }
